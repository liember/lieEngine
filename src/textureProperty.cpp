...
textureProperty::textureProperty(PropertyControlSystem *pcs) : property(PROPERTY_TEXTURE)
{
...
void textureProperty::addTexture(SDL_Texture *t)
{
    texture = t;
}

void textureProperty::draw()
{
    texturemanager::draw(texture, destR);
}
...
void textureProperty::setTextureSize(int s)
{
    destR.w = destR.h = texSize = s;
}

void textureProperty::set(SDL_Texture *tex)
{
    texture = tex;
}

SDL_Texture *textureProperty::getTexture()
{
    return texture;
}