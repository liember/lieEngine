...
positionLimitProperty::positionLimitProperty(PropertyControlSystem *pcs)
    : property(PROPERTY_POSITION_LIMIT)
{
...
void positionLimitProperty::setBot(double s) { set(&limYbot, s); }

void positionLimitProperty::setTop(double s) { set(&limYtop, s); }

void positionLimitProperty::setLeft(double s) { set(&limXleft, s); }

void positionLimitProperty::setRight(double s) { set(&limXriht, s); }

double positionLimitProperty::getBot() { return *limYbot; }

double positionLimitProperty::getTop() { return *limYtop; }

double positionLimitProperty::getLeftWall() { return *limXleft; }

double positionLimitProperty::getRightWall() { return *limXriht; }
